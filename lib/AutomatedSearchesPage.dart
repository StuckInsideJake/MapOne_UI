...
Future AccessAutoSearches(String kw)
async
{
  // get request
  var response = await http.get(Uri.parse("https://mapone-api.herokuapp.com/entry/?action=1&keyword=${kw}"));
...
Future<EntryDataGridSource> getSearchDataSource(String kw) async
{
  var entryList = await AccessAutoSearches(kw);
...
class _autoSearchState extends State<autoSearchPage>
{

  String username = autoSearchPage.un;
  String password = autoSearchPage.pw;
          ...
          [
            ...
            IconButton(
              ...
              onPressed: (){
                setState(() {
                  Navigator.pop(context);
                  Navigator.push(context, MaterialPageRoute(builder: (context) => login(autoSearchPage.un, autoSearchPage.pw)));
                });
              },
            ),
            IconButton(
        ...
        Row(mainAxisAlignment: MainAxisAlignment.center,
          ...
          children: [
            ...
            Expanded( child: FittedBox(fit: BoxFit.contain,
              child:  FutureBuilder(
                future: getSearchDataSource(autoSearchPage.kw),
